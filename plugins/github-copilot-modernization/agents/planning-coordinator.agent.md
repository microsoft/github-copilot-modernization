...
hooks:
  PostToolUse:
    - type: command
      command: "APPMOD_AGENT=migration bash \"$APPMOD_HOOK_SCRIPTS_DIR/sendTelemetry.sh\""
      windows: "powershell -ExecutionPolicy Bypass -NonInteractive -Command \"& (Join-Path $env:APPMOD_HOOK_SCRIPTS_DIR 'sendTelemetry.ps1') -AgentName migration\""
---
